...
<!-- UsageSnippet language="php" operationID="hris.companiesAll2" method="get" path="/hris/companies" -->
```php
...
$request = new Operations\HrisCompaniesAll2Request(
...
$responses = $sdk->hris->companies->all(
    request: $request
);
...
**[?Operations\HrisCompaniesAll2Response](../../Models/Operations/HrisCompaniesAll2Response.md)**
