...
$responses = $sdk->fileStorage->driveGroups->list(
    request: $request
);
...
**[?Operations\FileStorageDriveGroupsAllResponse](../../Models/Operations/FileStorageDriveGroupsAllResponse.md)**
...
$response = $sdk->fileStorage->driveGroups->get(
    request: $request
);
...
**[?Operations\FileStorageDriveGroupsOneResponse](../../Models/Operations/FileStorageDriveGroupsOneResponse.md)**
