...
class ListMembers
{
     ...
     *
     *
     * @param  \Apideck\Unify\Models\Operations\CrmListMembersAllRequest  $request
     * @return \Apideck\Unify\Models\Operations\CrmListMembersAllResponse
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    private function listIndividual(Operations\CrmListMembersAllRequest $request, ?Options $options = null): Operations\CrmListMembersAllResponse
    {
        $retryConfig = null;
        if ($options) {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/crm/lists/{id}/members', Operations\CrmListMembersAllRequest::class, $request, $this->sdkConfiguration->globals);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];

        $qp = Utils\Utils::getQueryParams(Operations\CrmListMembersAllRequest::class, $request, $urlOverride, $this->sdkConfiguration->globals);
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'crm.listMembersAll', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Apideck\Unify\Models\Components\GetListMembersResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\CrmListMembersAllResponse(
                ...
                $response->next = function () use ($sdk, $responseData, $request): ?Operations\CrmListMembersAllResponse {
     ...
     *
     * @param  \Apideck\Unify\Models\Operations\CrmListMembersAllRequest  $request
     * @return \Generator<\Apideck\Unify\Models\Operations\CrmListMembersAllResponse>
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    public function list(Operations\CrmListMembersAllRequest $request, ?Options $options = null): \Generator
    {
