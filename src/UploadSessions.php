...
class UploadSessions
{
     ...
     */
    public function create(Operations\FileStorageUploadSessionsAddRequest $request, ?string $serverURL = null): Operations\FileStorageUploadSessionsAddResponse
    {
        ...
        $hookContext = new HookContext('fileStorage.uploadSessionsAdd', null, $this->sdkConfiguration->securitySource);
     ...
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    public function get(Operations\FileStorageUploadSessionsOneRequest $request, ?string $serverURL = null): Operations\FileStorageUploadSessionsOneResponse
    {
        ...
        $hookContext = new HookContext('fileStorage.uploadSessionsOne', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $options['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $options = Utils\Utils::convertHeadersToOptions($httpRequest, $options);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
     ...
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    public function delete(Operations\FileStorageUploadSessionsDeleteRequest $request): Operations\FileStorageUploadSessionsDeleteResponse
    {
        ...
        $hookContext = new HookContext('fileStorage.uploadSessionsDelete', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $options['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $options = Utils\Utils::convertHeadersToOptions($httpRequest, $options);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
     ...
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    public function finish(Operations\FileStorageUploadSessionsFinishRequest $request, ?string $serverURL = null): Operations\FileStorageUploadSessionsFinishResponse
    {
        ...
        $options['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext('fileStorage.uploadSessionsFinish', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $options['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $options = Utils\Utils::convertHeadersToOptions($httpRequest, $options);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
