...
class BillPayments
{
     ...
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    private function listIndividual(?Operations\AccountingBillPaymentsAllRequest $request = null): Operations\AccountingBillPaymentsAllResponse
    {
        $baseUrl = $this->sdkConfiguration->getServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/accounting/bill-payments');
        $urlOverride = null;
     ...
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    public function list(?Operations\AccountingBillPaymentsAllRequest $request = null): \Generator
    {
