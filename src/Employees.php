...
class Employees
{
     ...
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    private function listIndividual(?Operations\HrisEmployeesAllRequest $request = null): Operations\HrisEmployeesAllResponse
    {
        $baseUrl = $this->sdkConfiguration->getServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/hris/employees');
        $urlOverride = null;
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->next = function () use ($sdk, $responseData, $request): ?Operations\HrisEmployeesAllResponse {
                    ...
                    $filter = new Components\EmployeesFilter(
                        ...
                        managerId: $request != null ? $request->filter->managerId : null,
                        employmentStatus: $request != null ? $request->filter->employmentStatus : null,
                        employeeNumber: $request != null ? $request->filter->employeeNumber : null,
                        departmentId: $request != null ? $request->filter->departmentId : null,
                    );
     ...
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    public function list(?Operations\HrisEmployeesAllRequest $request = null): \Generator
    {
