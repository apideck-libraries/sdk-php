...
class Companies
{
     ...
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    private function listIndividual(?Operations\CrmCompaniesAllRequest $request = null): Operations\CrmCompaniesAllResponse
    {
        $baseUrl = $this->sdkConfiguration->getServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/crm/companies');
        $urlOverride = null;
     ...
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    public function list(?Operations\CrmCompaniesAllRequest $request = null): \Generator
    {
