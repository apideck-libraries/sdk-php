...
class Companies
{
    ...
    private function listIndividual(?Operations\AccountingCompaniesAllRequest $request = null, ?Options $options = null): Operations\AccountingCompaniesAllResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/accounting/companies');
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];

        $qp = Utils\Utils::getQueryParams(Operations\AccountingCompaniesAllRequest::class, $request, $urlOverride, $this->sdkConfiguration->globals);
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'accounting.companiesAll', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\AccountingCompaniesAllResponse(
                ...
                $response->next = function () use ($sdk, $responseData, $request): ?Operations\AccountingCompaniesAllResponse {
