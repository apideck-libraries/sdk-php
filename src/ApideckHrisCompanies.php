...
class ApideckHrisCompanies
{
     ...
     * List Companies
     *
     * @param  ?Operations\HrisCompaniesAll2Request  $request
     * @return Operations\HrisCompaniesAll2Response
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    private function allIndividual(?Operations\HrisCompaniesAll2Request $request = null, ?Options $options = null): Operations\HrisCompaniesAll2Response
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $qp = Utils\Utils::getQueryParams(Operations\HrisCompaniesAll2Request::class, $request, $urlOverride, $this->sdkConfiguration->globals);
        $httpOptions = array_merge_recursive($httpOptions, Utils\Utils::getHeaders($request, $this->sdkConfiguration->globals));
        if (! array_key_exists('headers', $httpOptions)) {
            $httpOptions['headers'] = [];
        }
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'hris.companiesAll2', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\HrisCompaniesAll2Response(
                    httpMeta: new Components\HTTPMetadata(
                        response: $httpResponse,
                        request: $httpRequest
                    ),
                ...
                $response->next = function () use ($sdk, $responseData, $request): ?Operations\HrisCompaniesAll2Response {
     ...
     *
     * @param  ?Operations\HrisCompaniesAll2Request  $request
     * @return \Generator<Operations\HrisCompaniesAll2Response>
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    public function all(?Operations\HrisCompaniesAll2Request $request = null, ?Options $options = null): \Generator
    {
        $res = $this->allIndividual($request, $options);
        while ($res !== null) {
            yield $res;
            $res = $res->next($res);
        }
