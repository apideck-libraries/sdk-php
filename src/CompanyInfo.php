...
class CompanyInfo
{
     ...
     */
    public function get(?Operations\AccountingCompanyInfoOneRequest $request = null): Operations\AccountingCompanyInfoOneResponse
    {
        ...
        $qp = Utils\Utils::getQueryParams(Operations\AccountingCompanyInfoOneRequest::class, $request, $urlOverride, $this->sdkConfiguration->globals);
        ...
        $hookContext = new HookContext('accounting.companyInfoOne', null, $this->sdkConfiguration->securitySource);
        ...
        if ($statusCode == 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Apideck\Unify\Models\Components\GetCompanyInfoResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\AccountingCompanyInfoOneResponse(
