...
class Products
{
     ...
     */
    private function listIndividual(?Operations\EcommerceProductsAllRequest $request = null): Operations\EcommerceProductsAllResponse
    {
        ...
        $qp = Utils\Utils::getQueryParams(Operations\EcommerceProductsAllRequest::class, $request, $urlOverride, $this->sdkConfiguration->globals);
        ...
        $hookContext = new HookContext('ecommerce.productsAll', null, $this->sdkConfiguration->securitySource);
        ...
        if ($statusCode == 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Apideck\Unify\Models\Components\GetProductsResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\EcommerceProductsAllResponse(
                ...
                $response->next = function () use ($sdk, $responseData, $request): ?Operations\EcommerceProductsAllResponse {
     ...
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    public function list(?Operations\EcommerceProductsAllRequest $request = null): \Generator
    {
     ...
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    public function get(Operations\EcommerceProductsOneRequest $request): Operations\EcommerceProductsOneResponse
    {
        $baseUrl = $this->sdkConfiguration->getServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/ecommerce/products/{id}', Operations\EcommerceProductsOneRequest::class, $request, $this->sdkConfiguration->globals);
        $urlOverride = null;
        $options = ['http_errors' => false];

        $qp = Utils\Utils::getQueryParams(Operations\EcommerceProductsOneRequest::class, $request, $urlOverride, $this->sdkConfiguration->globals);
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request, $this->sdkConfiguration->globals));
        if (! array_key_exists('headers', $options)) {
            $options['headers'] = [];
        }
        ...
        $options['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext('ecommerce.productsOne', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $options['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $options = Utils\Utils::convertHeadersToOptions($httpRequest, $options);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        ...
        if ($statusCode == 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Apideck\Unify\Models\Components\GetProductResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\EcommerceProductsOneResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
