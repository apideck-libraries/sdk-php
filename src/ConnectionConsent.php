...
class ConnectionConsent
{
    ...
    public function update(Operations\VaultConnectionConsentUpdateRequest $request, ?Options $options = null): Operations\VaultConnectionConsentUpdateResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/vault/connections/{unified_api}/{service_id}/consent', Operations\VaultConnectionConsentUpdateRequest::class, $request, $this->sdkConfiguration->globals);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, 'updateConsentRequest', 'json');
        if ($body === null) {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'vault.connectionConsentUpdate', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Apideck\Unify\Models\Components\UpdateConsentResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\VaultConnectionConsentUpdateResponse(
