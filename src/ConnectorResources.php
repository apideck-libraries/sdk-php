...
class ConnectorResources
{
     ...
     */
    public function get(string $id, string $resourceId, ?string $appId = null, ?Components\UnifiedApiId $unifiedApi = null): Operations\ConnectorConnectorResourcesOneResponse
    {
