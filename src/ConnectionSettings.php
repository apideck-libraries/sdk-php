...
class ConnectionSettings
{
    ...
    public function list(Operations\VaultConnectionSettingsAllRequest $request): Operations\VaultConnectionSettingsAllResponse
    {
        ...
        $hookContext = new HookContext('vault.connectionSettingsAll', null, $this->sdkConfiguration->securitySource);
    ...
    public function update(Operations\VaultConnectionSettingsUpdateRequest $request): Operations\VaultConnectionSettingsUpdateResponse
    {
        ...
        $hookContext = new HookContext('vault.connectionSettingsUpdate', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $options = Utils\Utils::convertHeadersToOptions($httpRequest, $options);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
