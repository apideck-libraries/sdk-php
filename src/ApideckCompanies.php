...
class ApideckCompanies
{
     ...
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    private function listIndividual(?Operations\HrisCompaniesAllRequest $request = null): Operations\HrisCompaniesAllResponse
    {
        $baseUrl = $this->sdkConfiguration->getServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/hris/companies');
        $urlOverride = null;
     ...
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    public function list(?Operations\HrisCompaniesAllRequest $request = null): \Generator
    {
