...
class GetPayrollResponse
{
    ...
    /**
     *
     * @var \Apideck\Unify\Models\Components\Payroll $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Apideck\Unify\Models\Components\Payroll')]
    public Payroll $data;
     ...
     * @param  \Apideck\Unify\Models\Components\Payroll  $data
     * @param  ?\Apideck\Unify\Models\Components\Meta  $meta
     * @param  ?array<string, mixed>  $raw
     * @phpstan-pure
     */
    public function __construct(int $statusCode, string $status, string $service, string $resource, string $operation, Payroll $data, ?Meta $meta = null, ?array $raw = null)
    {
