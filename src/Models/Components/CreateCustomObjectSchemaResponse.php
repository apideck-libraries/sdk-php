...
class CreateCustomObjectSchemaResponse
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(int $statusCode, string $status, string $service, string $resource, string $operation, CustomObjectSchema $data, ?array $raw = null)
    {
