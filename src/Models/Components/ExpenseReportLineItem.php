...
class ExpenseReportLineItem
{
     ...
     * @phpstan-pure
     */
    public function __construct(float $amount, ?string $id = null, ?ExpenseReportLineItemExpenseCategory $expenseCategory = null, ?LinkedTaxRate $taxRate = null, ?LinkedLedgerAccount $account = null, ?string $description = null, ?float $quantity = null, ?float $unitPrice = null, ?float $taxAmount = null, ?float $totalAmount = null, ?LocalDate $transactionDate = null, ?bool $billable = null, ?bool $reimbursable = null, ?LinkedCustomer $customer = null, ?LinkedDepartment $department = null, ?LinkedLocation $location = null, ?array $trackingCategories = null, ?string $receiptUrl = null, ?Currency $currency = null)
    {
        $this->amount = $amount;
        $this->id = $id;
