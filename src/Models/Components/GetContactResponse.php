...
class GetContactResponse
{
    ...
    /**
     *
     * @var \Apideck\Unify\Models\Components\Contact $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Apideck\Unify\Models\Components\Contact')]
    public Contact $data;
     ...
     * @param  \Apideck\Unify\Models\Components\Contact  $data
     * @param  ?\Apideck\Unify\Models\Components\Meta  $meta
     * @param  ?array<string, mixed>  $raw
     * @phpstan-pure
     */
    public function __construct(int $statusCode, string $status, string $service, string $resource, string $operation, Contact $data, ?Meta $meta = null, ?array $raw = null)
    {
