...
class GetGoodsReceiptResponse
{
    ...
    /**
     *
     * @var \Apideck\Unify\Models\Components\GoodsReceipt $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Apideck\Unify\Models\Components\GoodsReceipt')]
     ...
     * @param  \Apideck\Unify\Models\Components\GoodsReceipt  $data
     * @param  ?\Apideck\Unify\Models\Components\Meta  $meta
     * @param  ?array<string, mixed>  $raw
     * @phpstan-pure
     */
    public function __construct(int $statusCode, string $status, string $service, string $resource, string $operation, GoodsReceipt $data, ?Meta $meta = null, ?array $raw = null)
    {
