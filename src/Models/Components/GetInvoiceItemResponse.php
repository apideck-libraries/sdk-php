...
class GetInvoiceItemResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(int $statusCode, string $status, string $service, string $resource, string $operation, InvoiceItem $data, ?Meta $meta = null, ?array $raw = null)
    {
