...
class GetApplicationResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(int $statusCode, string $status, string $service, string $resource, string $operation, Application $data, ?Meta $meta = null, ?array $raw = null)
    {
