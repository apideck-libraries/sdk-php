...
class GetFolderResponse
{
    ...
    /**
     *
     * @var \Apideck\Unify\Models\Components\Folder $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Apideck\Unify\Models\Components\Folder')]
    public Folder $data;
     ...
     * @param  \Apideck\Unify\Models\Components\Folder  $data
     * @param  ?\Apideck\Unify\Models\Components\Meta  $meta
     * @param  ?array<string, mixed>  $raw
     * @phpstan-pure
     */
    public function __construct(int $statusCode, string $status, string $service, string $resource, string $operation, Folder $data, ?Meta $meta = null, ?array $raw = null)
    {
