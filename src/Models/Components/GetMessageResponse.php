...
class GetMessageResponse
{
    ...
    /**
     *
     * @var \Apideck\Unify\Models\Components\Message $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Apideck\Unify\Models\Components\Message')]
    public Message $data;
     ...
     * @param  \Apideck\Unify\Models\Components\Message  $data
     * @param  ?\Apideck\Unify\Models\Components\Meta  $meta
     * @param  ?array<string, mixed>  $raw
     * @phpstan-pure
     */
    public function __construct(int $statusCode, string $status, string $service, string $resource, string $operation, Message $data, ?Meta $meta = null, ?array $raw = null)
    {
