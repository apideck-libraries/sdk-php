...
class GetInvoiceResponse
{
    ...
    /**
     *
     * @var \Apideck\Unify\Models\Components\Invoice $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Apideck\Unify\Models\Components\Invoice')]
    public Invoice $data;
     ...
     * @param  \Apideck\Unify\Models\Components\Invoice  $data
     * @param  ?\Apideck\Unify\Models\Components\Meta  $meta
     * @param  ?array<string, mixed>  $raw
     * @phpstan-pure
     */
    public function __construct(int $statusCode, string $status, string $service, string $resource, string $operation, Invoice $data, ?Meta $meta = null, ?array $raw = null)
    {
