...
class GeneralLedgerTransactionsSort
{
    /**
     * The field on which to sort the General Ledger Transactions.
     *
     * @var ?\Apideck\Unify\Models\Components\GeneralLedgerTransactionsSortBy $by
     */
    #[SpeakeasyMetadata('queryParam:name=by')]
    public ?GeneralLedgerTransactionsSortBy $by = null;
    ...
    /**
     * @param  ?\Apideck\Unify\Models\Components\GeneralLedgerTransactionsSortBy  $by
     * @param  ?\Apideck\Unify\Models\Components\SortDirection  $direction
     * @phpstan-pure
     */
    public function __construct(?GeneralLedgerTransactionsSortBy $by = null, ?SortDirection $direction = SortDirection::Asc)
    {
        $this->by = $by;
