...
class GetApiResourceResponse
{
    ...
    /**
     *
     * @var \Apideck\Unify\Models\Components\ApiResource $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Apideck\Unify\Models\Components\ApiResource')]
     ...
     * @param  string  $status
     * @param  \Apideck\Unify\Models\Components\ApiResource  $data
     * @param  ?\Apideck\Unify\Models\Components\Meta  $meta
     * @param  ?\Apideck\Unify\Models\Components\Links  $links
     * @param  ?array<string, mixed>  $raw
     * @phpstan-pure
     */
    public function __construct(int $statusCode, string $status, ApiResource $data, ?Meta $meta = null, ?Links $links = null, ?array $raw = null)
    {
