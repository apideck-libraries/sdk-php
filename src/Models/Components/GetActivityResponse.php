...
class GetActivityResponse
{
    ...
    /**
     *
     * @var \Apideck\Unify\Models\Components\Activity $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Apideck\Unify\Models\Components\Activity')]
     ...
     * @param  \Apideck\Unify\Models\Components\Activity  $data
     * @param  ?\Apideck\Unify\Models\Components\Meta  $meta
     * @param  ?array<string, mixed>  $raw
     * @phpstan-pure
     */
    public function __construct(int $statusCode, string $status, string $service, string $resource, string $operation, Activity $data, ?Meta $meta = null, ?array $raw = null)
    {
