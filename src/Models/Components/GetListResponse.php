...
class GetListResponse
{
    ...
    /**
     *
     * @var \Apideck\Unify\Models\Components\ListT $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Apideck\Unify\Models\Components\ListT')]
    public ListT $data;
     ...
     * @param  \Apideck\Unify\Models\Components\ListT  $data
     * @param  ?\Apideck\Unify\Models\Components\Meta  $meta
     * @param  ?array<string, mixed>  $raw
     * @phpstan-pure
     */
    public function __construct(int $statusCode, string $status, string $service, string $resource, string $operation, ListT $data, ?Meta $meta = null, ?array $raw = null)
    {
