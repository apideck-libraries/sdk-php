...
class AccountingSuppliersAddRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(Components\SupplierInput $supplier, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?string $companyId = null, ?bool $raw = false)
    {
