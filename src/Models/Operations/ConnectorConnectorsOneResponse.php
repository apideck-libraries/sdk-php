...
class ConnectorConnectorsOneResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\GetConnectorResponse $getConnectorResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
