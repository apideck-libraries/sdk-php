...
class AtsApplicantsAllRequest
{
     ...
     * @param  ?string  $fields
     */
    public function __construct(?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?Components\ApplicantsFilter $filter = null, ?array $passThrough = null, ?string $cursor = null, ?string $fields = null, ?bool $raw = false, ?int $limit = 20)
    {
