...
class AccountingCustomersAddRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CustomerInput $customer, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?string $companyId = null, ?bool $raw = false)
    {
