...
class AccountingSubsidiariesAllResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\GetSubsidiariesResponse $getSubsidiariesResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
