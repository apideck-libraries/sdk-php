...
class HrisPayrollsOneResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\GetPayrollResponse $getPayrollResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
