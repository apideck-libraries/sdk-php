...
class AccountingEmployeesAllRequest
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?Components\AccountingEmployeesFilter $filter = null, ?array $passThrough = null, ?string $cursor = null, ?string $fields = null, ?bool $raw = false, ?int $limit = 20)
    {
