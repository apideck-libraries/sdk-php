...
class CrmActivitiesAddRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(Components\ActivityInput $activity, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
