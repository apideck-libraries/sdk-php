...
class VaultValidateConnectionStateResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\ValidateConnectionStateResponse $validateConnectionStateResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
