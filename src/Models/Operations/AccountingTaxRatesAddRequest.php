...
class AccountingTaxRatesAddRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(Components\TaxRateInput $taxRate, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?string $companyId = null, ?bool $raw = false)
    {
