...
class EcommerceProductsOneResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\GetProductResponse $getProductResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
