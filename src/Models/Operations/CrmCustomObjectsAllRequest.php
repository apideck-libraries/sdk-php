...
class CrmCustomObjectsAllRequest
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(string $objectId, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?array $passThrough = null, ?string $cursor = null, ?string $fields = null, ?bool $raw = false, ?int $limit = 20)
    {
