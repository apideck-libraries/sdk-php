...
class CrmPipelinesDeleteResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\DeletePipelineResponse $deletePipelineResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
