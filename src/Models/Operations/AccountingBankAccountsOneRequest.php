...
class AccountingBankAccountsOneRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, ?Components\BankAccountFilter $filter = null, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?string $companyId = null, ?string $fields = null, ?bool $raw = false)
    {
        $this->id = $id;
        $this->filter = $filter;
