...
class CrmCustomObjectsDeleteRequest
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, string $objectId, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
        $this->id = $id;
