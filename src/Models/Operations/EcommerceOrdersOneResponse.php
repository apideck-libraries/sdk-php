...
class EcommerceOrdersOneResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\GetEcommerceOrderResponse $getEcommerceOrderResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
