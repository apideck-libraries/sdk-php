...
class AccountingTrackingCategoriesUpdateRequest
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, Components\TrackingCategoryInput $trackingCategory, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?string $companyId = null, ?bool $raw = false)
    {
        $this->id = $id;
