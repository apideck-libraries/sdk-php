...
class AccountingLedgerAccountsUpdateResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\UpdateLedgerAccountResponse $updateLedgerAccountResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
