...
class AtsApplicationsAddRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(Components\ApplicationInput $application, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
