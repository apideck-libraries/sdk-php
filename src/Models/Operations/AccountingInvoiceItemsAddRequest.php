...
class AccountingInvoiceItemsAddRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(Components\InvoiceItemInput $invoiceItem, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?string $companyId = null, ?bool $raw = false)
    {
