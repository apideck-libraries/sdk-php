...
class AccountingRefundsAddRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(Components\RefundInput $refund, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
        $this->refund = $refund;
