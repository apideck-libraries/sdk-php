...
class CrmPipelinesAddRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(Components\PipelineInput $pipeline, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
