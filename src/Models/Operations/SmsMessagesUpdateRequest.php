...
class SmsMessagesUpdateRequest
{
    /**
     ...
     * @param  ?bool  $raw
     */
    public function __construct(string $id, Components\MessageInput $message, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
        $this->id = $id;
