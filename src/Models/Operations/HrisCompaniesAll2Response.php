...
class HrisCompaniesAll2Response
{
    /**
     *
    ...
    /**
     * @var \Closure(string): ?HrisCompaniesAll2Response $next
     */
    public \Closure $next;
    /**
     ...
     * @return ?HrisCompaniesAll2Response
     */
    public function __call($name, $args): ?HrisCompaniesAll2Response
    {
        if ($name === 'next') {
