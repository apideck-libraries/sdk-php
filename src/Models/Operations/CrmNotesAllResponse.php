...
class CrmNotesAllResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\GetNotesResponse $getNotesResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
