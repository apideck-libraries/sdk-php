...
class AccountingBankFeedStatementsUpdateRequest
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, Components\BankFeedStatementInput $bankFeedStatement, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
        $this->id = $id;
