...
class AccountingPurchaseOrdersAddRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(Components\PurchaseOrderInput $purchaseOrder, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?string $companyId = null, ?bool $raw = false)
    {
