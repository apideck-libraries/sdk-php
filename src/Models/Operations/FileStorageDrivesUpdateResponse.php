...
class FileStorageDrivesUpdateResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\UpdateDriveResponse $updateDriveResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
