...
class AccountingJournalEntriesAllRequest
{
     ...
     * @param  ?string  $fields
     */
    public function __construct(?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?Components\JournalEntriesFilter $filter = null, ?Components\JournalEntriesSort $sort = null, ?array $passThrough = null, ?string $cursor = null, ?string $fields = null, ?bool $raw = false, ?int $limit = 20)
    {
        $this->raw = $raw;
