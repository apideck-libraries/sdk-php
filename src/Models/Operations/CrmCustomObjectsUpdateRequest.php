...
class CrmCustomObjectsUpdateRequest
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, string $objectId, Components\CustomObjectInput $customObject, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
        $this->id = $id;
