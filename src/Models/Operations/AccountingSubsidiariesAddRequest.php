...
class AccountingSubsidiariesAddRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(Components\SubsidiaryInput $subsidiary, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?string $companyId = null, ?bool $raw = false)
    {
