...
class FileStorageDriveGroupsAllRequest
{
    /**
     ...
     * @param  ?string  $fields
     */
    public function __construct(?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?Components\DriveGroupsFilter $filter = null, ?array $passThrough = null, ?string $cursor = null, ?string $fields = null, ?bool $raw = false, ?int $limit = 20)
    {
