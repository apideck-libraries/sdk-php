...
class CrmCompaniesAllResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\GetCompaniesResponse $getCompaniesResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
