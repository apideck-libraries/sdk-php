...
class AccountingPurchaseOrdersAllRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?string $companyId = null, ?array $passThrough = null, ?Components\PurchaseOrdersFilter $filter = null, ?Components\PurchaseOrdersSort $sort = null, ?string $cursor = null, ?bool $raw = false, ?int $limit = 20)
    {
