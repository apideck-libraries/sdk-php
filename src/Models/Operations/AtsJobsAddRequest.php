...
class AtsJobsAddRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(Components\JobInput $job, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
        $this->job = $job;
