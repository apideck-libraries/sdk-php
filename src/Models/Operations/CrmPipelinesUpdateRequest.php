...
class CrmPipelinesUpdateRequest
{
    /**
     ...
     * @param  ?bool  $raw
     */
    public function __construct(string $id, Components\PipelineInput $pipeline, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
        $this->id = $id;
