...
class AccountingExpenseReportsAddRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(Components\ExpenseReportInput $expenseReport, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
