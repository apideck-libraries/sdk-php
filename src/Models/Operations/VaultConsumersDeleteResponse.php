...
class VaultConsumersDeleteResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\DeleteConsumerResponse $deleteConsumerResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
