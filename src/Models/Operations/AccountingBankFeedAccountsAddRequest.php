...
class AccountingBankFeedAccountsAddRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(Components\BankFeedAccountInput $bankFeedAccount, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
