...
class IssueTrackingCollectionUsersOneResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\GetCollectionUserResponse $getCollectionUserResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
