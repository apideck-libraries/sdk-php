...
class AccountingExpensesAddResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\CreateExpenseResponse $createExpenseResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
