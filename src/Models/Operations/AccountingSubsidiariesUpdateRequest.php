...
class AccountingSubsidiariesUpdateRequest
{
     ...
     * @param  ?bool  $raw
     */
    public function __construct(string $id, Components\SubsidiaryInput $subsidiary, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
        $this->id = $id;
