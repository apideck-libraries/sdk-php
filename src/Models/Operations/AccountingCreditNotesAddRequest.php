...
class AccountingCreditNotesAddRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CreditNoteInput $creditNote, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?string $companyId = null, ?bool $raw = false)
    {
