...
class AccountingCreditNotesAllResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\GetCreditNotesResponse $getCreditNotesResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
