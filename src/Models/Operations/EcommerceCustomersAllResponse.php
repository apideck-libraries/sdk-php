...
class EcommerceCustomersAllResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\GetEcommerceCustomersResponse $getEcommerceCustomersResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
