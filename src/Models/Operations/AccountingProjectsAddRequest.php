...
class AccountingProjectsAddRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(Components\ProjectInput $project, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?string $companyId = null, ?bool $raw = false)
    {
