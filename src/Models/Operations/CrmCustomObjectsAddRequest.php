...
class CrmCustomObjectsAddRequest
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(string $objectId, Components\CustomObjectInput $customObject, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
