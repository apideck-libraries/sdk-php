...
class HrisEmployeesAddRequest
{
     ...
     */
    public function __construct(Components\EmployeeInput $employee, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
