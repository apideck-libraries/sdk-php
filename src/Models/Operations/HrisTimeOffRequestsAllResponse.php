...
class HrisTimeOffRequestsAllResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\GetTimeOffRequestsResponse $getTimeOffRequestsResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
