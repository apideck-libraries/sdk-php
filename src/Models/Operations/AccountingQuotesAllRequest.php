...
class AccountingQuotesAllRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?string $companyId = null, ?Components\QuotesFilter $filter = null, ?array $passThrough = null, ?string $cursor = null, ?bool $raw = false, ?int $limit = 20)
    {
