...
class VaultConnectionConsentUpdateRequest
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(string $serviceId, string $unifiedApi, Components\UpdateConsentRequest $updateConsentRequest, ?string $consumerId = null, ?string $appId = null)
    {
