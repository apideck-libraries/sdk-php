...
class WebhookEventLogsAllRequest
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(?string $appId = null, ?Components\WebhookEventLogsFilter $filter = null, ?string $cursor = null, ?int $limit = 20)
    {
        $this->appId = $appId;
        $this->filter = $filter;
        $this->cursor = $cursor;
