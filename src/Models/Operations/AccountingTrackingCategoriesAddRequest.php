...
class AccountingTrackingCategoriesAddRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(Components\TrackingCategoryInput $trackingCategory, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?string $companyId = null, ?bool $raw = false)
    {
