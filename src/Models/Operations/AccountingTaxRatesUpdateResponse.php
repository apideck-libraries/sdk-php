...
class AccountingTaxRatesUpdateResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\UpdateTaxRateResponse $updateTaxRateResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
