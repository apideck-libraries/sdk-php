...
class AccountingQuotesAddRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(Components\QuoteInput $quote, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?string $companyId = null, ?bool $raw = false)
    {
        $this->quote = $quote;
