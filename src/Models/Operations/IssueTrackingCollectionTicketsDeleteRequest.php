...
class IssueTrackingCollectionTicketsDeleteRequest
{
    /**
     ...
     * @param  ?bool  $raw
     */
    public function __construct(string $ticketId, string $collectionId, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
