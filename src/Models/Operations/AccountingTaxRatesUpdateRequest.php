...
class AccountingTaxRatesUpdateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, Components\TaxRateInput $taxRate, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?string $companyId = null, ?bool $raw = false)
    {
        $this->id = $id;
