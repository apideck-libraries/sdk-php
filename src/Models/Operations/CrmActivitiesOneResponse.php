...
class CrmActivitiesOneResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\GetActivityResponse $getActivityResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
