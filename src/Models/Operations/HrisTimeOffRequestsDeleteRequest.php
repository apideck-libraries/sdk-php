...
class HrisTimeOffRequestsDeleteRequest
{
    /**
     ...
     * @param  ?bool  $raw
     */
    public function __construct(string $id, string $employeeId, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
        $this->id = $id;
