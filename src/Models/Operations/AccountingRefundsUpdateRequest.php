...
class AccountingRefundsUpdateRequest
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, Components\RefundInput $refund, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
        $this->id = $id;
        $this->refund = $refund;
