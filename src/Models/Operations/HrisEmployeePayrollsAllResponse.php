...
class HrisEmployeePayrollsAllResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\GetEmployeePayrollsResponse $getEmployeePayrollsResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
