...
class CrmUsersDeleteResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\DeleteUserResponse $deleteUserResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
