...
class AccountingPaymentsAddRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(Components\PaymentInput $payment, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?string $companyId = null, ?bool $raw = false)
    {
