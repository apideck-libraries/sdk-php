...
class AccountingBankFeedStatementsAddRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(Components\BankFeedStatementInput $bankFeedStatement, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
