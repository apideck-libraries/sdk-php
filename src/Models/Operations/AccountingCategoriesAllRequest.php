...
class AccountingCategoriesAllRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?string $companyId = null, ?Components\CategoriesFilter $filter = null, ?string $cursor = null, ?string $fields = null, ?bool $raw = false, ?int $limit = 20)
    {
