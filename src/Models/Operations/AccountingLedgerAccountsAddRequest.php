...
class AccountingLedgerAccountsAddRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(Components\LedgerAccountInput $ledgerAccount, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?string $companyId = null, ?bool $raw = false)
    {
