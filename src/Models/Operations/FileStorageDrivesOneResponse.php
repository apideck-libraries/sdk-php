...
class FileStorageDrivesOneResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\GetDriveResponse $getDriveResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
