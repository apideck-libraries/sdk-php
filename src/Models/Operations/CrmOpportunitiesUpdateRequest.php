...
class CrmOpportunitiesUpdateRequest
{
    /**
     ...
     * @param  ?bool  $raw
     */
    public function __construct(string $id, Components\OpportunityInput $opportunity, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
        $this->id = $id;
