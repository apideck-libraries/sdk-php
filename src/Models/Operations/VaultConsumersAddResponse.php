...
class VaultConsumersAddResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\CreateConsumerResponse $createConsumerResponse = null, ?Components\UnexpectedErrorResponse $unexpectedErrorResponse = null)
    {
