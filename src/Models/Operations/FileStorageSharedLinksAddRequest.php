...
class FileStorageSharedLinksAddRequest
{
    /**
     *
     ...
     */
    public function __construct(Components\SharedLinkInput $sharedLink, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
