...
class AtsJobsUpdateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, Components\JobInput $job, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
        $this->id = $id;
        $this->job = $job;
