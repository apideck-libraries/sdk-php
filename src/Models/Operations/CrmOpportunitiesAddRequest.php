...
class CrmOpportunitiesAddRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(Components\OpportunityInput $opportunity, ?string $consumerId = null, ?string $appId = null, ?string $serviceId = null, ?bool $raw = false)
    {
