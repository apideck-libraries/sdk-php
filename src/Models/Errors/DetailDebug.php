...
class DetailDebug
{
    ...
    public ?DetailRequest $request = null;
    ...
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?DetailResponse $response = null;
     ...
     * @phpstan-pure
     */
    public function __construct(?DetailRequest $request = null, ?DetailResponse $response = null, ?string $message = null, ?string $code = null, ?float $credentialsExpireAtMs = null, ?float $retryAfterMs = null, ?float $cooldownRemainingMs = null)
    {
