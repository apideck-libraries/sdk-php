...
class SDKConfiguration
{
    ...
    public string $openapiDocVersion = '10.24.0';

    public string $sdkVersion = '0.18.0';

    public string $genVersion = '2.845.19';

    public string $userAgent = 'speakeasy-sdk/php 0.18.0 2.845.19 10.24.0 apideck-libraries/sdk-php';
