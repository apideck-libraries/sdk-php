...
class CustomMappings
{
     ...
     */
    public function list(string $unifiedApi, string $serviceId, ?string $consumerId = null, ?string $appId = null): Operations\VaultCustomMappingsAllResponse
    {
        $request = new Operations\VaultCustomMappingsAllRequest(
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/vault/custom-mappings/{unified_api}/{service_id}', Operations\VaultCustomMappingsAllRequest::class, $request, $this->sdkConfiguration->globals);
        $urlOverride = null;
        ...
        $hookContext = new HookContext('vault.customMappingsAll', null, $this->sdkConfiguration->securitySource);
        ...
        if ($statusCode == 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\VaultCustomMappingsAllResponse(
