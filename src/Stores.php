...
class Stores
{
     ...
     */
    public function get(?Operations\EcommerceStoresOneRequest $request = null): Operations\EcommerceStoresOneResponse
    {
        ...
        $qp = Utils\Utils::getQueryParams(Operations\EcommerceStoresOneRequest::class, $request, $urlOverride, $this->sdkConfiguration->globals);
        ...
        $hookContext = new HookContext('ecommerce.storesOne', null, $this->sdkConfiguration->securitySource);
        ...
        if ($statusCode == 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Apideck\Unify\Models\Components\GetStoreResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\EcommerceStoresOneResponse(
