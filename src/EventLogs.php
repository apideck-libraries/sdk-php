...
class EventLogs
{
    ...
    private function listIndividual(?string $appId = null, ?string $cursor = null, ?int $limit = null, ?Components\WebhookEventLogsFilter $filter = null, ?Options $options = null): Operations\WebhookEventLogsAllResponse
    {
        ...
        $request = new Operations\WebhookEventLogsAllRequest(
            appId: $appId,
            cursor: $cursor,
            limit: $limit,
            filter: $filter,
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/webhook/logs');
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];

        $qp = Utils\Utils::getQueryParams(Operations\WebhookEventLogsAllRequest::class, $request, $urlOverride, $this->sdkConfiguration->globals);
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'webhook.eventLogsAll', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Apideck\Unify\Models\Components\GetWebhookEventLogsResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\WebhookEventLogsAllResponse(
                    httpMeta: new Components\HTTPMetadata(
                        response: $httpResponse,
                        request: $httpRequest
                    ),
                    getWebhookEventLogsResponse: $obj
                );
                $sdk = $this;
