...
class GoodsReceipts
{
     ...
     * List Goods Receipts
     *
     * @param  ?\Apideck\Unify\Models\Operations\AccountingGoodsReceiptsAllRequest  $request
     * @return \Apideck\Unify\Models\Operations\AccountingGoodsReceiptsAllResponse
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    private function listIndividual(?Operations\AccountingGoodsReceiptsAllRequest $request = null, ?Options $options = null): Operations\AccountingGoodsReceiptsAllResponse
    {
        $retryConfig = null;
        if ($options) {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/accounting/goods-receipts');
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];

        $qp = Utils\Utils::getQueryParams(Operations\AccountingGoodsReceiptsAllRequest::class, $request, $urlOverride, $this->sdkConfiguration->globals);
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'accounting.goodsReceiptsAll', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Apideck\Unify\Models\Components\GetGoodsReceiptsResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\AccountingGoodsReceiptsAllResponse(
                ...
                $response->next = function () use ($sdk, $responseData, $request): ?Operations\AccountingGoodsReceiptsAllResponse {
     ...
     *
     * @param  ?\Apideck\Unify\Models\Operations\AccountingGoodsReceiptsAllRequest  $request
     * @return \Generator<\Apideck\Unify\Models\Operations\AccountingGoodsReceiptsAllResponse>
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    public function list(?Operations\AccountingGoodsReceiptsAllRequest $request = null, ?Options $options = null): \Generator
    {
     ...
     * Get Goods Receipt
     *
     * @param  \Apideck\Unify\Models\Operations\AccountingGoodsReceiptsOneRequest  $request
     * @return \Apideck\Unify\Models\Operations\AccountingGoodsReceiptsOneResponse
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    public function get(Operations\AccountingGoodsReceiptsOneRequest $request, ?Options $options = null): Operations\AccountingGoodsReceiptsOneResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/accounting/goods-receipts/{id}', Operations\AccountingGoodsReceiptsOneRequest::class, $request, $this->sdkConfiguration->globals);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];

        $qp = Utils\Utils::getQueryParams(Operations\AccountingGoodsReceiptsOneRequest::class, $request, $urlOverride, $this->sdkConfiguration->globals);
        $httpOptions = array_merge_recursive($httpOptions, Utils\Utils::getHeaders($request, $this->sdkConfiguration->globals));
        if (! array_key_exists('headers', $httpOptions)) {
            $httpOptions['headers'] = [];
        }
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'accounting.goodsReceiptsOne', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Apideck\Unify\Models\Components\GetGoodsReceiptResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\AccountingGoodsReceiptsOneResponse(
                    httpMeta: new Components\HTTPMetadata(
                        response: $httpResponse,
                        request: $httpRequest
                    ),
