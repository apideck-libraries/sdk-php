...
class ConnectionConsents
{
    ...
    public function list(string $serviceId, string $unifiedApi, ?string $consumerId = null, ?string $appId = null, ?Options $options = null): Operations\VaultConnectionConsentsAllResponse
    {
        ...
        $request = new Operations\VaultConnectionConsentsAllRequest(
            serviceId: $serviceId,
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/vault/connections/{unified_api}/{service_id}/consent', Operations\VaultConnectionConsentsAllRequest::class, $request, $this->sdkConfiguration->globals);
        $urlOverride = null;
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'vault.connectionConsentsAll', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Apideck\Unify\Models\Components\GetConsentRecordsResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\VaultConnectionConsentsAllResponse(
