...
class ConnectionCustomMappings
{
     ...
     */
    public function list(Operations\VaultConnectionCustomMappingsAllRequest $request): Operations\VaultConnectionCustomMappingsAllResponse
    {
        ...
        $hookContext = new HookContext('vault.connectionCustomMappingsAll', null, $this->sdkConfiguration->securitySource);
