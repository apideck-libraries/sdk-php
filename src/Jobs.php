...
class Jobs
{
     ...
     */
    private function listIndividual(?Operations\AtsJobsAllRequest $request = null): Operations\AtsJobsAllResponse
    {
        ...
        $hookContext = new HookContext('ats.jobsAll', null, $this->sdkConfiguration->securitySource);
     ...
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    public function list(?Operations\AtsJobsAllRequest $request = null): \Generator
    {
     ...
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    public function get(Operations\AtsJobsOneRequest $request): Operations\AtsJobsOneResponse
    {
        $baseUrl = $this->sdkConfiguration->getServerUrl();
        ...
        $options['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext('ats.jobsOne', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $options['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $options = Utils\Utils::convertHeadersToOptions($httpRequest, $options);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
