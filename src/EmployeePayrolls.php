...
class EmployeePayrolls
{
     ...
     */
    public function list(Operations\HrisEmployeePayrollsAllRequest $request): Operations\HrisEmployeePayrollsAllResponse
    {
     ...
     * @throws \Apideck\Unify\Models\Errors\APIException
     */
    public function get(Operations\HrisEmployeePayrollsOneRequest $request): Operations\HrisEmployeePayrollsOneResponse
    {
        $baseUrl = $this->sdkConfiguration->getServerUrl();
